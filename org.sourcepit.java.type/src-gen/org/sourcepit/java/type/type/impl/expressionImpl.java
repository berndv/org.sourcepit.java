 ...
 * <ul>
 * <li>{@link org.sourcepit.java.type.type.impl.expressionImpl#getDummy <em>Dummy</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class expressionImpl extends variableInitializerImpl implements expression {
   ...
   protected EClass eStaticClass() {
      return TypePackage.Literals.EXPRESSION;
   }
   ...
   public void setDummy(String newDummy) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, TypePackage.EXPRESSION__DUMMY, oldDummy, dummy));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case TypePackage.EXPRESSION__DUMMY :
            return getDummy();
      }
