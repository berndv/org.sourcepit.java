 ...
 * <ul>
 * <li>{@link org.sourcepit.java.type.type.impl.exceptionTypeImpl#getAnnotations <em>Annotations</em>}</li>
 * <li>{@link org.sourcepit.java.type.type.impl.exceptionTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class exceptionTypeImpl extends MinimalEObjectImpl.Container implements exceptionType {
   ...
   protected EClass eStaticClass() {
      return TypePackage.Literals.EXCEPTION_TYPE;
   }
   ...
   public EList<annotation> getAnnotations() {
      if (annotations == null) {
         annotations = new EObjectContainmentEList<annotation>(annotation.class, this,
            TypePackage.EXCEPTION_TYPE__ANNOTATIONS);
      }
      return annotations;
   }
   ...
   public void setName(String newName) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, TypePackage.EXCEPTION_TYPE__NAME, oldName, name));
   }
