...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>unann Array Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.sourcepit.java.type.type.impl.unannArrayTypeImpl#getDims <em>Dims</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class unannArrayTypeImpl extends unannReferenceTypeImpl implements unannArrayType {
   /**
   ...
   protected EClass eStaticClass() {
      return TypePackage.Literals.UNANN_ARRAY_TYPE;
   }
   ...
   public NotificationChain basicSetDims(dims newDims, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
            TypePackage.UNANN_ARRAY_TYPE__DIMS, oldDims, newDims);
         if (msgs == null)
            msgs = notification;
         else
      ...
      if (newDims != dims) {
         ...
         if (dims != null)
            msgs = ((InternalEObject) dims).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
               - TypePackage.UNANN_ARRAY_TYPE__DIMS, null, msgs);
         if (newDims != null)
         ...
         eNotify(new ENotificationImpl(this, Notification.SET, TypePackage.UNANN_ARRAY_TYPE__DIMS, newDims, newDims));
   }
