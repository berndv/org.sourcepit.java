 ...
 * <ul>
 * <li>{@link org.sourcepit.java.java.impl.ModelImpl#getLiterals <em>Literals</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model {
   ...
   public EList<Literal> getLiterals() {
      if (literals == null) {
         literals = new EObjectContainmentEList<Literal>(Literal.class, this, JavaPackage.MODEL__LITERALS);
      }
      return literals;
   }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case JavaPackage.MODEL__LITERALS :
